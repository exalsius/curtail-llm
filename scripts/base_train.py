...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="flwr_pilot", name=args.run, config=user_config)
...
while True:
    ...
    promised_flops_per_sec_a100 = 312e12 * ddp_world_size # bfloat16 A100
