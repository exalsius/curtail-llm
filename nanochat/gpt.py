...
#     print0(f"WARNING: flash-attention-3 not available, falling back to SDPA: {e}")
#     flash_attn = None
flash_attn = None
        ...
        if kv_cache is None:
            ...
            if flash_attn is not None:
                ...
                if self.layer_idx == kv_cache.n_layers - 1:
                 ...
                 # Minimal fallback for inference (ignoring complex KV cache management for now or crashing gracefully)
                 # Since this is a specialized fallback, maybe just raising error for inference is safer than silent wrongness?
                 # But training is the main goal.
                 raise NotImplementedError("Inference with KV cache not supported without flash-attention-3 yet.")
